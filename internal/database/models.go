...
// ZabbixSettings stores Zabbix integration configuration
...
// IsConfigured returns true if webhook secret is set
func (z *ZabbixSettings) IsConfigured() bool {
	return z.WebhookSecret != ""
}

// IsActive returns true if Zabbix is enabled and configured
func (z *ZabbixSettings) IsActive() bool {
	return z.Enabled && z.IsConfigured()
}

// TableName returns the table name for ZabbixSettings
func (ZabbixSettings) TableName() string {
...
const (
	...
	EventSourceTypeZabbix EventSourceType = "zabbix"
